...
model_path = 'C:/Users/servet.badem/Desktop/project_root/ml_models/nlp_model/knn_model.pkl'
vectorizer_path = 'C:/Users/servet.badem/Desktop/project_root/ml_models/nlp_model/tfidf_vectorizer.pkl'
...
async def create_hasta_metin(hasta_metin: HastaMetinCreate, db: Session = Depends(get_db)):
    db_hasta = HastaMetin(hasta_no=hasta_metin.hasta_no, paragraf=hasta_metin.paragraf)
    db.add(db_hasta)
    db.commit()
    db.refresh(db_hasta)
    return db_hasta
